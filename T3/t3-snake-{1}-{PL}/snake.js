async function instantiate(module, imports = {}) {
  ...
  const adaptedExports = Object.setPrototypeOf({
    greedy_snake_step(n, snake, snake_num, other_snakes, food_num, foods, round) {
      // assembly/index/greedy_snake_step(i32, ~lib/typedarray/Int32Array, f64, ~lib/typedarray/Int32Array, f64, ~lib/typedarray/Int32Array, f64) => f64
    ...
    greedy_snake_move(snake, food, size) {
      // assembly/index/greedy_snake_move(~lib/typedarray/Int32Array, ~lib/typedarray/Int32Array, i32) => i32
      snake = __retain(__lowerTypedArray(Int32Array, 4, 2, snake) || __notnull());
      food = __lowerTypedArray(Int32Array, 4, 2, food) || __notnull();
      try {
        return exports.greedy_snake_move(snake, food, size);
      } finally {
        __release(snake);
      }
    },
