...
assert.strictEqual(
    ...
    1 // Expect out of range since the snake will hit the boundary
);
...
assert.strictEqual(
    ...
    true // Expect to successfully eat the food
);
...
console.log("Return num is "+greedy_snake_barriers_checker(
    [4,4,4,3,4,2,4,1], 
    1,                  
    [8,8],                              
    [5,4,5,5,5,6,6,4,6,6,7,4,7,6],
    1             
) )
// 蛇在障碍物之间穿行测试
assert.strictEqual(
...
console.log("🎉 You have passed all the additional tests.");
